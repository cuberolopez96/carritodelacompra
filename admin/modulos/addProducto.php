...
if(isset($_POST['add'])&&isset($_POST['nombre'])&&isset($_POST['username'])&&isset($_POST['psw'])){
    $usuario = new Usuario($_POST['nombre'],$_POST['username'],$_POST['psw'],'admin');
    $modelUsuarios->add($usuario);
    
}
?>
<div id="formulario">
    <form action=<?php echo $_SERVER['PHP_SELF'].'?opcion=gestionusuarios&tipogestion=add'; ?> method="post">
