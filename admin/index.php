        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href=<?php echo $_SERVER['PHP_SELF']."?opcion=usuarios"?>><i class="fa fa-fw fa-bar-chart-o"></i> Usuarios</a>
                    </li>
                    <li>
                        <a href=<?php echo "$_SERVER[PHP_SELF]?opcion=productos" ?>><i class="fa fa-fw fa-table"></i> Productos</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        if(isset($_GET['opcion'])){
                            switch($_GET['opcion']){
                                case "usuarios":
                                    require_once "modulos/adminUsuarios.php";
                                    break;
                                case "gestionusuarios":
                                    require_once "modulos/gestionUsuarios.php";
                                    break;
                                case "productos":
                                    require_once "modulos/adminProductos.php";
                                    break;
                                case "gestionproductos":
                                    require_once "modulos/gestionProductos.php";
                                    break;
                                case "pedidos":
